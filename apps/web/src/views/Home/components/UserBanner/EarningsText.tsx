...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and NEBULA pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and NEBULA pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from NEBULA pool', data)
  }
